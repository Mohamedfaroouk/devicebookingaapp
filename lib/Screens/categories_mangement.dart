...
class CategoriesManagementScreen extends StatelessWidget {
  ...
  TextEditingController imageUrleditController = TextEditingController();
  void update(BuildContext context, MainProvider value, index) async {
    ...
    await value
        .updateCategory(
            nameeditController.text, imageUrleditController.text, index)
        .then((value) {
                      ...
                      TextFormField(
                        ...
                        validator: (String? val) {
                          if (val!.isEmpty
                              ...
                              //         ||
                              //     (!val.endsWith('png') && !val.endsWith('jpg'))
                              ) {
